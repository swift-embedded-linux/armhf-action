...
> [!WARNING]  
> Cross-compiling Swift modules with Swift 6.2 is broken when `.Cxx` interop is enabled due to this bug: https://github.com/swiftlang/swift/issues/83915. Some targets may work, but if you need C++ interop you may want to skip this release. The issue is fixed in Swift 6.2.1 and later.
