...
> [!WARNING]
>
> - Cross-compiling Swift modules with **Swift 6.2** is broken when `.Cxx` interop is enabled due to this bug: https://github.com/swiftlang/swift/issues/83915. This is fixed from Swift 6.2.1 and up.
>
> - Cross-compiling Swift modules with **Swift 6.3/6.3.1** is broken when `.Cxx` interop is enabled due to this bug: https://github.com/swiftlang/swift/issues/88420. The issue is fixed in Swift 6.3.2 and up.
>
